...
public class PostingLostActivity extends AppCompatActivity {
    ...
    private void submitForm() {
        ...
        ApiHelper.createLostFound(
                deskripsi,
                selectedLokasi,
                "hilang", // kategori sesuai dengan tabel
                selectedImageFile,
                ...
                new ApiHelper.ApiCallback() {
                    ...
                    public void onSuccess(String result) {
                        runOnUiThread(() -> {
                            Toast.makeText(PostingLostActivity.this,
    ...
    // Tidak diperlukan method resetState dan setSelected karena sudah ditangani di popup
}